...
#  * of the figure.
#  
class GArc(GObject, GFillable, GScalable):
    ...
    def __init__(self, width, height, start, sweep):
    ...
    def __init___0(self, x, y, width, height, start, sweep):
    ...
    def setFrameRectangle(self, x, y, width, height):
    ...
    def setFrameRectangle_0(self, bounds):
    ...
    #  
   # @overloaded     def scale(self, sx, sy, self, sx, sy):
...
class ArcRenderer(Serializable):
    ...
    def addArc(self, x, y, width, height, start, sweep):
