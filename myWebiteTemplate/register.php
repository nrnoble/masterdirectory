...
<div id = "tryit" class="page" onclick="$(showit_hidit).toggle();">
    <div id ="show_hide" onclick="$(tryitimg2).toggle();">Click me to show\hide Assignment instructions</div>


    <div id="showit_hidit" style="display: none;">
    <img id = "tryitimg2"  src="tryit_register.png" alt="image" style="max-width: 100%; max-height: 50%;" >
    </div>
</div>
