...
<div>
    ...
    <div class = 'page' style="margin-top: 10px">
        <a href = "http://nnoble.greenrivertech.net/7/7a.php#gpa">Link to Student List</a>
    </div>

</div>
                <div style = "display: none" id ="newstudentform"  class ="page">
                ...
                <div id ="pgaUpdateform" class ="page">
                    ...
                    <h1>NewStudent GPA update Form</h1>
