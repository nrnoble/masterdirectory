#!/usr/bin/env python
""" generated source for module GRoundRect """
...
class GRoundRect(GRect):
    """ generated source for class GRoundRect """
    ...
    def __init__(self, width, height):
        ...
        super(GRoundRect, self).__init__()
        self.__init__(0, 0, width, height, self.DEFAULT_ARC)
    ...
    def __init___0(self, x, y, width, height):
        ...
        super(GRoundRect, self).__init__()
        self.__init__(x, y, width, height, self.DEFAULT_ARC)
    ...
    #  
    @__init__.register(object, float, float, float, float, float)
    def __init___1(self, x, y, width, height, arcSize):
        """ generated source for method __init___1 """
        super(GRoundRect, self).__init__()
        self.__init__(x, y, width, height, arcSize, arcSize)
    ...
    def __init___2(self, x, y, width, height, arcWidth, arcHeight):
        """ generated source for method __init___2 """
        super(GRoundRect, self).__init__(height)
        aWidth = arcWidth
        aHeight = arcHeight
        renderer = GArc(self)
    ...
    def getArcWidth(self):
        """ generated source for method getArcWidth """
        return aWidth
    ...
    def getArcHeight(self):
        """ generated source for method getArcHeight """
        return aHeight
    ...
    def paint(self, g):
        ...
        if (isinstance(comp, (GCanvas, ))) and not (comp).getNativeArcFlag():
            ...
            r = getAWTBounds()
            iArcWidth = Ground(aWidth)
            iArcHeight = Ground(aHeight)
            if isFilled():
