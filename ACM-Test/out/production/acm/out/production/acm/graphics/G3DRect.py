#!/usr/bin/env python
""" generated source for module G3DRect """
...
#  
class G3DRect(GRect):
    """ generated source for class G3DRect """
    ...
    def __init__(self, width, height):
        ...
        super(G3DRect, self).__init__()
        self.__init__(0, 0, width, height, False)
    ...
    def __init___0(self, x, y, width, height):
        ...
        super(G3DRect, self).__init__()
        self.__init__(x, y, width, height, False)
    ...
    #  
    @__init__.register(object, float, float, float, float, bool)
    def __init___1(self, x, y, width, height, raised):
        """ generated source for method __init___1 """
        super(G3DRect, self).__init__(height)
        isRaised = raised
    ...
    def setRaised(self, raised):
        """ generated source for method setRaised """
        isRaised = raised
    ...
    #  
    def isRaised(self):
        """ generated source for method isRaised """
