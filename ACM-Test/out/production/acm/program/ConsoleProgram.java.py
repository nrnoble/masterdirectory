#!/usr/bin/env python
""" generated source for module ConsoleProgram """
...
class ConsoleProgram(Program):
    """ generated source for class ConsoleProgram """
    ...
    def __init__(self):
        ...
        super(ConsoleProgram, self).__init__()
    ...
    def setFont(self, str_):
        ...
        console = getConsole()
        if console != None:
            console.setFont(str_)
            super(ConsoleProgram, self).setFont(console.getFont())
    ...
    def setFont_0(self, font):
        ...
        super(ConsoleProgram, self).setFont(font)
