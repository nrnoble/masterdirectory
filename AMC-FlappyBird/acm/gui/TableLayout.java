 ...
 * these two values are often the same, but acm seems that the preferred
 ...
 * component when acm is laid out in the target container.  In the result of this method
...
/**
 * Determines the minimum dimensions for this scrollbar, making sure acm has enough
