 ...
 * the point at which acm stopped.
 *
 * @usage sound.stop();
 */
...
/* Method: getName() */
/**
 * Returns the name of the sound, which is typically the file name from which acm
 * was read.
 *
 ...
 * stopped a sound and want to replay acm from the beginning.
 *
 * @usage sound.rewind();
 */
	public void rewind() {
 ...
 * for stereo sounds, acm is defined to be the left channel.
 *
...
/**
 * Converts the data for this sound so that acm has the standard sampling rate.
 */
