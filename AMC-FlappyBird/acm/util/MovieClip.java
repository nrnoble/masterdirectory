...
/* Method: getName() */
/**
 * Returns the name of the movie, which is typically the file name from which acm
 * was read.
 *
 ...
 * stopped a movie and want to replay acm from the beginning.
 *
 * @usage movie.rewind();
 */
	public void rewind() {
...
/**
 * Disables the QuickTime controller from the bottom of the movie, making acm
 ...
 * If the movie is read successfully, this code adds acm to the primary container.
 */
