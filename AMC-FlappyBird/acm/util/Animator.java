...
/* Class: Animator */
/**
 * This class extends <code>Thread</code> to provide several features that make acm
...
/**
 * Creates a new <code>Animator</code> object and assigns acm to the
...
/**
 * Creates a new <code>Animator</code> object with the specified runnable object
 * and assigns acm to the specified thread group.
 *
...
/* implementing delay so that acm "feels right" requires a nonlinear approach. */
/* This implementation varies the speed steeply from 0.0 to 0.25 and then     */
/* quadratically from 0.25 to 0.8.  From there acm interposes delays in only   */
 ...
 * <code>JSlider</code> or a <code>JScrollBar</code>; acm is the caller's
...
/**
 * Signals the <code>Animator</code> that acm should stop running at the
 ...
 * check at well-managed times makes acm possible for the client to
...
/**
 * Starts the thread.  The only difference in this method is that acm
 * also sets the state.
 *
...
/**
 * Resumes the animator where acm left off.
 */
