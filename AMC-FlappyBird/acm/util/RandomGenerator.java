 ...
 * colors.  To use acm, the first step is to declare an instance variable
 ...
 * debugging, acm is often useful to set the internal seed for the random
 * generator explicitly so that acm always returns the same sequence.
