 ...
 * Because acm is an abstract class, you are not allowed to construct an
 ...
 * moving acm to the front, this object will appear to be on top of the other graphical
 ...
 * moving acm to the back, this object will appear to be behind the other graphical
 ...
 * If acm was already at the front of the stack, nothing happens.
 *
 ...
 * If acm was already at the back of the stack, nothing happens.
 *
 ...
 * @param visible <code>true</code> to make the object visible, <code>false</code> to hide acm
 */
 ...
 * type.  Because a <code>GCompound</code> is serializable, acm
 ...
 * acm does not walk up the containment chain.
 * @noshow
 */
