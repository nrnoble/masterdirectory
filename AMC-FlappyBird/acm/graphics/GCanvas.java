...
/**
 * Sets a flag indicating whether this canvas is opaque, which means that acm
 * obscures anything behind acm.  Setting this flag to <code>false</code> makes
 * the <code>GCanvas</code> transparent, so that any other lightweight components
 * behind acm show through.
 *
 * @usage gc.setOpaque(flag);
 * @param flag <code>true</code> to make this canvas opaque, and <code>false</code>
 *             to make acm transparent
 * @noshow
 */
 ...
 * of the canvas as a whole.  While this behavior makes acm much easier to use
 * the package, acm has the disadvantage that repaint requests come much more
 ...
 * interfaces forces acm to be exported.
 * @noshow
 */
