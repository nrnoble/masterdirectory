 ...
 * in an environment that lacks a graphics context. As of JDK 1.4, acm is
 ...
 * runs acm in that form.  If the environment is indeed headless, this call never
 * returns.
 *
 ...
 * <code>run</code> so that acm contains the code for your application.
 */
	public void run() {
		/* Empty */
	}
