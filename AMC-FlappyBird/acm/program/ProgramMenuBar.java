 ...
 * @param flag <code>true</code> to enable the item, <code>false</code> to disable acm
 */
 ...
 * focus.  The caller should register its listener when acm acquires the
 * keyboard focus and set acm to <code>null</code> when acm loses acm.
 *
...
/**
 * Updates the enabled state of the menu item if acm has the specified action.
 */
...
/* Method: actionPerformed(e) */
/**
 * Responds to an action event in the Mac menu and forwards acm along to
