#!/usr/bin/env python
""" generated source for module RandomGenerator """
...
class RandomGenerator(Random):
    ...
    @overloaded
    def nextInt(self, n):
        """ generated source for method nextInt """
        return self.nextInt(0, n - 1)
    ...
    def nextBoolean(self):
        """ generated source for method nextBoolean """
        return self.nextBoolean(0.5)
    ...
    #  
    @nextInt.register(object, int, int)
    def nextInt_0(self, low, high):
        """ generated source for method nextInt_0 """
    ...
    #  
    def nextDouble(self, low, high):
        """ generated source for method nextDouble """
        return low + (high - low) * self.nextDouble()
    ...
    #  
    @nextBoolean.register(object, float)
    def nextBoolean_0(self, p):
        """ generated source for method nextBoolean_0 """
    ...
    #  
    def nextColor(self):
        """ generated source for method nextColor """
        return Color(self.nextInt(256), self.nextInt(256), self.nextInt(256))
    ...
    def getInstance(cls):
        ...
        if standardInstance == None:
            standardInstance = RandomGenerator()
...
RandomGenerator.#  * @usage RandomGenerator rgen = RandomGenerator.getInstance();
