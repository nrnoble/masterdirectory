#!/usr/bin/env python
""" generated source for module GLabel """
...
class GLabel(GObject):
    """ generated source for class GLabel """
    ...
    #  
    DEFAULT_FONT = Font("Default", Font.PLAIN, 12)
    ...
    def __init___0(self, str_, x, y):
        """ generated source for method __init___0 """
        super(GLabel, self).__init__()
        label = str_
        setFont(self.DEFAULT_FONT)
        setLocation(x, y)
    ...
    #  
    @setFont.register(object, str)
    def setFont_0(self, str_):
    ...
    #  
    def setLabel(self, str_):
        """ generated source for method setLabel """
        label = str_
        repaint()
    ...
    #  
    def getLabel(self):
        """ generated source for method getLabel """
        return label
    ...
    def paint(self, g):
        ...
        g.setFont(labelFont)
        g.drawString(label, Ground(getX()), Ground(getY()))
    ...
    #  
    def getAscent(self):
        """ generated source for method getAscent """
    ...
    #  
    def getDescent(self):
        """ generated source for method getDescent """
    ...
    def getBounds(self):
        ...
        return GRectangle(getX(), getY() - self.getAscent(), self.getWidth(), self.getHeight())
    ...
    def paramString(self):
        ...
        return super(GLabel, self).paramString() + ", string=\"" + label + "\""

    #  Private instance variables 
    label = None
    labelFont = None
    DUMMY_COMPONENT = MediaTools.getImageObserver()
